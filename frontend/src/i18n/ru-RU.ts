export default {
  ...
  internal: {
    ...
    forbiddenOrError: "Нет доступа (только штат) или ошибка запроса.",
  },
  friends: {
    title: "Друзья",
    addById: "Запрос в друзья по ID пользователя",
  ...
  communities: {
    ...
    mineTitle: "Мои сообщества",
    mineEmpty: "Вы пока ни в одном сообществе.",
    browseAll: "Все сообщества",
    loadError: "Не удалось загрузить список.",
    postAttach: "Картинка к посту (необязательно)",
    attachmentAlt: "Вложение к посту",
    hideFromFeed: "Скрыть из общей ленты",
  },
  feed: {
    title: "Лента",
    subtitle: "Посты со стен друзей и из сообществ, где вы участник.",
    empty: "Пока нет записей. Добавьте друзей или вступите в сообщество.",
    loadError: "Не удалось загрузить ленту.",
    wallOf: "Стена №{id}",
    attachmentAlt: "Вложение",
    report: "Пожаловаться",
    reportTitle: "Жалоба на пост",
    reportHint: "Кратко опишите нарушение (по желанию). Запись уйдёт модераторам.",
    reportReason: "Комментарий",
  ...
  work: {
    ...
    promptGroupName: "Название группы",
  ...
  console: {
    ...
    tabGroups: "Группы и права",
    tabOrgs: "Компании и отделы",
    tabCommunities: "Сообщества",
    groupsTitle: "Группы пользователей",
    groupName: "Название",
    groupSlug: "Slug",
    permissions: "Разрешения (коды)",
    ...
    effectivePerms: "Эффективные права",
    organizations: "Компании",
    departments: "Отделы",
    filterByOrg: "Фильтр по компании",
    newOrgName: "Название компании",
    newDeptName: "Название отдела",
    deptOrganization: "Компания",
    create: "Создать",
    loadOrgsError: "Не удалось загрузить оргструктуру.",
    ...
    communityPostsTitle: "Посты сообщества",
    deletePost: "Удалить",
    close: "Закрыть",
    edit: "Изменить",
    groupMembers: "Участники (id)",
    editGroupTitle: "Группа прав",
    cancel: "Отмена",
    deleteGroup: "Удалить группу",
    save: "Сохранить",
    deleteGroupConfirmTitle: "Удалить группу?",
    deleteGroupConfirmBody: "Пользователи потеряют связанные права этой группы.",
  },
  settings: {
  ...
  profile: {
    ...
    wallAttach: "Картинка к записи (необязательно)",
    attachmentAlt: "Вложение к записи",
    hideFromFeed: "Скрыть из общей ленты",
  },
  auth: {
    signInTitle: "Вход",
